...
var pipeData = {
    ...
    var wsfuFixtureCatalog = [
      { key: 'WATER_CLOSET_GRAVITY', label: 'Water Closet, Gravity Tank', privateWsfu: 2.5, publicWsfu: 5.0, assemblyWsfu: 5.0 },
      { key: 'WATER_CLOSET_FLUSHOMETER', label: 'Water Closet, Flushometer Valve', privateWsfu: 5.0, publicWsfu: 10.0, assemblyWsfu: 10.0 },
      { key: 'URINAL_FLUSHOMETER', label: 'Urinal, Flushometer Valve', privateWsfu: 3.0, publicWsfu: 5.0, assemblyWsfu: 5.0 },
      { key: 'LAVATORY', label: 'Lavatory', privateWsfu: 1.0, publicWsfu: 2.0, assemblyWsfu: 2.0 },
      { key: 'KITCHEN_SINK', label: 'Kitchen Sink', privateWsfu: 1.5, publicWsfu: 2.0, assemblyWsfu: 2.0 },
      { key: 'SERVICE_MOP_BASIN', label: 'Service or Mop Basin', privateWsfu: 2.5, publicWsfu: 3.0, assemblyWsfu: 3.0 },
      { key: 'SHOWER_SINGLE', label: 'Shower', privateWsfu: 2.0, publicWsfu: 4.0, assemblyWsfu: 4.0 },
      { key: 'BATHTUB_BATH_SHOWER', label: 'Bathtub or Combination Bath/Shower', privateWsfu: 4.0, publicWsfu: 4.0, assemblyWsfu: 4.0 },
      { key: 'DRINKING_FOUNTAIN', label: 'Drinking Fountain or Water Cooler', privateWsfu: 0.5, publicWsfu: 0.5, assemblyWsfu: 0.75 },
      { key: 'HOSE_BIBB', label: 'Hose Bibb', privateWsfu: 2.5, publicWsfu: 2.5, assemblyWsfu: 2.5 },
      { key: 'FLOOR_DRAIN', label: 'Floor Drain', privateWsfu: 0.0, publicWsfu: 0.0, assemblyWsfu: 0.0 }
    ];
    var ventFixtureCatalog = [
      { key: 'WATER_CLOSET_GRAVITY', label: 'Water Closet, Gravity Tank', privateDfu: 3.0, publicDfu: 4.0, assemblyDfu: 6.0 },
      { key: 'WATER_CLOSET_FLUSHOMETER', label: 'Water Closet, Flushometer Valve', privateDfu: 4.0, publicDfu: 6.0, assemblyDfu: 8.0 },
      { key: 'URINAL_FLUSHOMETER', label: 'Urinal, Flushometer Valve', privateDfu: 2.0, publicDfu: 4.0, assemblyDfu: 4.0 },
      { key: 'LAVATORY', label: 'Lavatory', privateDfu: 1.0, publicDfu: 1.0, assemblyDfu: 1.0 },
      { key: 'KITCHEN_SINK', label: 'Kitchen Sink', privateDfu: 2.0, publicDfu: 2.0, assemblyDfu: 2.0 },
      { key: 'SERVICE_MOP_BASIN', label: 'Service or Mop Basin', privateDfu: 2.0, publicDfu: 3.0, assemblyDfu: 3.0 },
      { key: 'SHOWER_SINGLE', label: 'Shower', privateDfu: 2.0, publicDfu: 2.0, assemblyDfu: 2.0 },
      { key: 'BATHTUB_BATH_SHOWER', label: 'Bathtub or Combination Bath/Shower', privateDfu: 2.0, publicDfu: 2.0, assemblyDfu: 2.0 },
      { key: 'DRINKING_FOUNTAIN', label: 'Drinking Fountain or Water Cooler', privateDfu: 0.5, publicDfu: 0.5, assemblyDfu: 1.0 },
    ...
    var fixtureUnitCatalog = [
      { key: 'WATER_CLOSET_GRAVITY', label: 'Water Closet, Gravity Tank', water: { private: 2.5, public: 5.0, assembly: 5.0 }, waste: { private: 3.0, public: 4.0, assembly: 6.0 } },
      { key: 'WATER_CLOSET_FLUSHOMETER', label: 'Water Closet, Flushometer Valve', water: { private: 5.0, public: 10.0, assembly: 10.0 }, waste: { private: 4.0, public: 6.0, assembly: 8.0 } },
      { key: 'URINAL_FLUSHOMETER', label: 'Urinal, Flushometer Valve', water: { private: 3.0, public: 5.0, assembly: 5.0 }, waste: { private: 2.0, public: 4.0, assembly: 4.0 } },
      { key: 'LAVATORY', label: 'Lavatory', water: { private: 1.0, public: 2.0, assembly: 2.0 }, waste: { private: 1.0, public: 1.0, assembly: 1.0 } },
      { key: 'KITCHEN_SINK', label: 'Kitchen Sink', water: { private: 1.5, public: 2.0, assembly: 2.0 }, waste: { private: 2.0, public: 2.0, assembly: 2.0 } },
      { key: 'SERVICE_MOP_BASIN', label: 'Service or Mop Basin', water: { private: 2.5, public: 3.0, assembly: 3.0 }, waste: { private: 2.0, public: 3.0, assembly: 3.0 } },
      { key: 'SHOWER_SINGLE', label: 'Shower', water: { private: 2.0, public: 4.0, assembly: 4.0 }, waste: { private: 2.0, public: 2.0, assembly: 2.0 } },
      { key: 'BATHTUB_BATH_SHOWER', label: 'Bathtub or Combination Bath/Shower', water: { private: 4.0, public: 4.0, assembly: 4.0 }, waste: { private: 2.0, public: 2.0, assembly: 2.0 } },
      { key: 'DRINKING_FOUNTAIN', label: 'Drinking Fountain or Water Cooler', water: { private: 0.5, public: 0.5, assembly: 0.75 }, waste: { private: 0.5, public: 0.5, assembly: 1.0 } },
      { key: 'HOSE_BIBB', label: 'Hose Bibb', water: { private: 2.5, public: 2.5, assembly: 2.5 }, waste: { private: null, public: null, assembly: null } },
      { key: 'FLOOR_DRAIN', label: 'Floor Drain', water: { private: 0.0, public: 0.0, assembly: 0.0 }, waste: { private: 2.0, public: 2.0, assembly: 2.0 } },
      { key: 'CLOTHES_WASHER', label: 'Clothes Washer', water: { private: 4.0, public: 4.0, assembly: 4.0 }, waste: { private: 3.0, public: 3.0, assembly: 3.0 } }
    ];
